...
type AnotherReplicaSetSpec struct {
...
type AnotherReplicaSet struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   AnotherReplicaSetSpec   `json:"spec,omitempty"`
	Status AnotherReplicaSetStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// AnotherReplicaSetList contains a list of AnotherReplicaSet
type AnotherReplicaSetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AnotherReplicaSet `json:"items"`
}

func init() {
	SchemeBuilder.Register(&AnotherReplicaSet{}, &AnotherReplicaSetList{})
}
